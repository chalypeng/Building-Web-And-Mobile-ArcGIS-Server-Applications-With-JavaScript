...
esri.InfoTemplate = function (title,content,json) {
    ...
    /// </signature>
    /// <signature>
    /// <summary>Creates a new InfoTemplate object.</summary>
...
esri.geometry.Circle = function (center,options,options) {
    /// <signature>
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a new Circle by specifying an object with a required center location, defined as a longitude/latitude array or an esri.geometry.Point, and the following additional optional parameters: radius, radiusUnits, geodesic, and numberOfPoints.</summary>
    /// <param name="options" type="Object" optional="true">If no center parameter is provided, it must be set within the options. See options descriptions for further information.&#10;
    /// &#60;Point | Number[]&#62; center&#10;
    /// &#60;Boolean&#62; geodesic&#10;
    /// &#60;Number&#62; numberOfPoints&#10;
    /// &#60;Number&#62; radius&#10;
...
esri.geometry.Point = function (x,y,spatialReference,xyCoord,spatialReference,json,long,lat,point,point) {
    /// <signature>
    ...
    /// </signature>
    /// <signature>
    /// <summary>Creates a new Point object using an array containing an x,y coordinate value and a spatial reference.At version 3.3 if a spatial reference is not provided a default spatial reference of 4326 will be assigned</summary>
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a point object and initialize it with the specified longitude and latitude</summary>
    /// <param name="long" type="Number" optional="false">Longitude value.</param>
    /// <param name="lat" type="Number" optional="false">Latitude value.</param>
    /// </signature>
    /// <signature>
    /// <summary>Create a point object andinitializeit with an array containing longitude and latitude values</summary>
    /// <param name="point" type="Number[]" optional="false">An input array containing the longitude and latitude values for the point.</param>
    /// </signature>
    /// <signature>
    /// <summary>Create a point object and initialize it with an object that has latitude and longitude properties</summary>
    /// <param name="point" type="Object" optional="false">An object with latitude and longitude properties.</param>
    /// </signature>
    /// <field name="spatialReference" type="SpatialReference">The spatial reference of the geometry.</field>
    /// <field name="type" type="String">The type of geometry</field>
...
esri.geometry.Polygon = function (spatialReference,json) {
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a new polygon by providing an array of geographic coordinate pairs.</summary>
    /// </signature>
...
esri.geometry.Polyline = function (spatialReference,json,coordinates) {
    /// <signature>
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a new polyline by providing an array of geographic coordinates.</summary>
    /// <param name="coordinates" type="Number[]" optional="false">An array of geographic coordinates that define the polyline.</param>
    /// </signature>
...
esri.layers.FeatureLayer = function (url,options,featureCollectionObject,options) {
    ...
    /// </signature>
    /// <signature>
    /// <summary>Creates a new instance of a feature layer using a FeatureCollection object.</summary>
    ...
    /// <param name="options" type="Object" optional="true">Optional parameters. See options list.</param>
    /// </signature>
...
esri.layers.GraphicsLayer = function (options) {
    ...
    /// <param name="options" type="Object" optional="true">See options list for parameters.&#10;
    /// &#60;String&#62; className&#10;
...
esri.layers.MosaicRule = function () {
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a new mosaic rule object using a json string representing a serialized version of the mosaic rule</summary>
    /// </signature>
...
esri.layers.RasterFunction = function () {
    ...
    /// </signature>
    /// <signature>
    /// <summary>Create a new Raster Function object using a json string representing a serialized version of a raster function</summary>
    /// </signature>
...
esri.layers.StreamLayer = function (url,options,featureCollectionObject,options) {
    /// <signature>
    ...
    /// </signature>
    /// <signature>
    /// <summary>Creates a new StreamLayer with a FeatureCollection object</summary>
...
esri.symbol.CartographicLineSymbol = function (style,color,width,cap,join,miterLimit,json) {
    ...
    /// <param name="style" type="String" optional="true">See Constants table for values.</param>
    ...
    /// <param name="width" type="Number" optional="true">Width of the line in pixels.</param>
    /// <param name="cap" type="String" optional="true">See Constants table for values.</param>
    /// <param name="join" type="String" optional="true">See Constants table for values.</param>
    /// <param name="miterLimit" type="String" optional="true">Size threshold for showing mitered line joins.</param>
    /// </signature>
    /// <signature>
...
esri.symbol.TextSymbol = function (text,text,font,color,json) {
    ...
    /// <param name="json" type="Object" optional="false">JSON object representing the TextSymbol. View the REST API Reference for Symbol Objects for details on creating a JSON symbol. Note that when specifying symbol width and height using JSON the values should be entered in points, the JavaScript API then converts the point values to pixels. The TextSymbol does not support backgroundColor, borderLineColor, verticalAlignment or horizontalAlignment properties. </param>
    /// </signature>
